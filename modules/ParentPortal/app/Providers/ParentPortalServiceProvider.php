...
use Modules\ParentPortal\App\Providers\EventServiceProvider;
use Modules\ParentPortal\App\Providers\RouteServiceProvider;
...
class ParentPortalServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'ParentPortal';

    protected string $nameLower = 'parentportal';

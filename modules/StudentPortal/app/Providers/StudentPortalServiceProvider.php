...
use Modules\StudentPortal\App\Providers\EventServiceProvider;
use Modules\StudentPortal\App\Providers\RouteServiceProvider;
...
class StudentPortalServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'StudentPortal';

    protected string $nameLower = 'studentportal';

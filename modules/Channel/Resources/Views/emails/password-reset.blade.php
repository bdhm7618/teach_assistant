...
<head>
    ...
    <title>{{ __('channel::app.mail.reset_password_subject') }}</title>
</head>
            ...
            <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="text-align:center;padding-bottom:16px;">
                        <h2 style="margin:0;color:#111827;">
                            {{ __('channel::app.mail.reset_password_title') }}
                        </h2>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="color:#374151;font-size:14px;line-height:1.7;padding-top:12px;">
                        {{ __('channel::app.mail.reset_password_text') }}
                    </td>
                </tr>
                ...
                <tr>
                    <td style="color:#6b7280;font-size:13px;text-align:center;">
                        {{ __('channel::app.mail.reset_otp_expire') }}
                    </td>
                </tr>
